...
class VectorNetwork()(implicit spade:Spade) extends GridNetwork() {
  type P = VectorIO.P
...
class ScalarNetwork()(implicit spade:Spade) extends GridNetwork() {
  type P = ScalarIO.P
...
class CtrlNetwork()(implicit spade:Spade) extends GridNetwork() {
  type P = ControlIO.P
